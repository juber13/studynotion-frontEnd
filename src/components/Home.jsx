  ...
  return (
    <div className='main-section flex flex-col  items-center justify-center w-full h-auto'>
      <div className='hero-section gap-5 flex flex-col mt-20 items-center justify-center max-w-2xl m-auto h-screen'>
        <button className='flex items-center  border gap-2 rounded-md shadow-md p-2 hover:bg-slate-200'>
          Become a instructor
          <span>
        ...
        <p className='text-lg text-center font-[300]'>
      ...
      <div className='my-course mt-3 mb-10 w-[90%'>
        <h3 className='text-2xl font-bold text-center text-slate-600'>Trending Courses</h3>
      <div className='flex items-center flex-wrap gap-6 mt-3 p-4 justify-center'> 
          {loading && <Loader/>}
